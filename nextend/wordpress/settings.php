...
function nextend_settings_add_page() {
	add_submenu_page('edit.php?post_type=accordion_menu', 'Nextend Settings', 'Settings', 'manage_options', __FILE__, 'nextend_settings_page');
}
...
<form method="post" id="nextend-settings" action="<?php echo admin_url("edit.php?post_type=accordion_menu&page=nextend/library/wordpress/settings.php"); ?>">
<?php
